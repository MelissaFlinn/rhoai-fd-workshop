= 3.4 Preparing the model for deployment
//title TBD
include::_attributes.adoc[]

After you train a model for inference, you can deploy that model by using the OpenShift Data Science model serving capabilities.

Firts, you must move the model from your workbench to your S3 compatible object storage.  You use the data connection that you created earlier in the section xref:1-03-data-connections.adoc[Storage Data Connections].  We'll simply upload the model from a notebook.
