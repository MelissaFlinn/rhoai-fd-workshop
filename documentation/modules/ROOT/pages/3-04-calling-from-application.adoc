...
.. In the OpenShift console, select *Topology*. 
...
.. In the Data Science dashboard, Select *+Add* and then click *Import from Git*.
+
...
. Return here when you're ready to continue with the {deliverable}.

.Next steps

xref:4-01-gui-pipelines.adoc[Automating workflows with data science pipelines]