= 2.3 Running code in a notebook
...
Code cells contain Python code that can be run interactively. You can modify the code and then run it. The code does not run on your computer or in the browser, but directly in the environment that you are connected to, *{productname-long}* in our case.
...
xref:2-04-experiment-train.adoc[Running code in a notebook]
