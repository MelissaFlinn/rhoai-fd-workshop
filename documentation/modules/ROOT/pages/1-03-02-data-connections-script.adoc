...
1. In the {productname-short} dashboard, select *Data Science Projects* to view the list of projects.
...
xref:1-04-enable-pipelines.adoc[Enabling data science pipelines]
